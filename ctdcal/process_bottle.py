...
def export_report_data(df):
    """Exports report_data.csv to the scratch folder, containing the essential data and flags for the report."""
    log.info("Writing report_data.csv")
    ...
    # Add flags not generated by other subroutines
    # TODO: Check if these columns exist already
...
def export_hy1(df, out_dir=cfg.dirs["pressure"], org="ODF"):
    """Exports bottle data formatted with units for bottle server.
    ...
    df : DataFrame
        Bottle CTD data
    out_dir : String
        Folder for writing file out
    org : String
        Organization/processing group
