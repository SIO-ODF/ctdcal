...
def btl_t1_residuals_pressure_plot(df):
    ...
    fig.savefig('./data/images/reftmp_t1_p.ps', format='ps')
    fig.savefig('./data/images/reftmp_t1_p.png', format='png')
    plt.close()
    return None
...
def btl_t2_residuals_pressure_plot(df):
    ...
    fig.savefig('./data/images/reftmp_t2_p.ps', format='ps')
    fig.savefig('./data/images/reftmp_t2_p.png', format='png')
    plt.close()
    return None
...
def t1_t2_residuals_pressure_plot(df):
    ...
    fig.savefig('./data/images/t1_t2_p.ps', format='ps')
    fig.savefig('./data/images/t1_t2_p.png', format='png')
    plt.close()
    return None
...
def btl_t1_residuals_station_plot(df):
    ...
    fig.savefig('./data/images/reftmp_t1_stn.ps', format='ps')
    fig.savefig('./data/images/reftmp_t1_stn.png', format='png')
    plt.close()
    return None
...
def btl_t2_residuals_station_plot(df):
    ...
    fig.savefig('./data/images/reftmp_t2_stn.ps', format='ps')
    fig.savefig('./data/images/reftmp_t2_stn.png', format='png')
    plt.close()
    return None
...
def t1_t2_residuals_station_plot(df):
    ...
    fig.savefig('./data/images/t1_t2_stn.ps', format='ps')
    fig.savefig('./data/images/t1_t2_stn.png', format='png')
    plt.close()
    return None
...
def btl_t1_residuals_station_deep_plot(df):
    ...
    fig.savefig('./data/images/reftmp_t1_stn_deep.ps', format='ps')
    fig.savefig('./data/images/reftmp_t1_stn_deep.png', format='png')
    plt.close()
    return None
...
def btl_t2_residuals_station_deep_plot(df):
    ...
    fig.savefig('./data/images/reftmp_t2_stn_deep.ps', format='ps')
    fig.savefig('./data/images/reftmp_t2_stn_deep.png', format='png')
    plt.close()
    return None
...
def t1_t2_residuals_station_deep_plot(df):
    ...
    fig.savefig('./data/images/t1_t2_stn_deep.ps', format='ps')
    fig.savefig('./data/images/t1_t2_stn_deep.png', format='png')
    plt.close()
    return None
...
def btl_c1_residuals_pressure_plot(df):
    ...
    fig.savefig('./data/images/btlcond_c1_p.ps', format='ps')
    fig.savefig('./data/images/btlcond_c1_p.png', format='png')
    plt.close()
    return None
...
def btl_c2_residuals_pressure_plot(df):
    ...
    fig.savefig('./data/images/btlcond_c2_p.ps', format='ps')
    fig.savefig('./data/images/btlcond_c2_p.png', format='png')
    plt.close()
    return None
...
def c1_c2_residuals_pressure_plot(df):
    ...
    fig.savefig('./data/images/c1_c2_p.ps', format='ps')
    fig.savefig('./data/images/c1_c2_p.png', format='png')
    plt.close()
    return None
...
def btl_c1_residuals_station_plot(df):
    ...
    fig.savefig('./data/images/btlcond_c1_stn.ps', format='ps')
    fig.savefig('./data/images/btlcond_c1_stn.png', format='png')
    plt.close()
    return None
...
def btl_c2_residuals_station_plot(df):
    ...
    fig.savefig('./data/images/btlcond_c2_stn.ps', format='ps')
    fig.savefig('./data/images/btlcond_c2_stn.png', format='png')
    plt.close()
    return None
...
def c1_c2_residuals_station_plot(df):
    ...
    fig.savefig('./data/images/c1_c2_stn.ps', format='ps')
    fig.savefig('./data/images/c1_c2_stn.png', format='png')
    plt.close()
    return None
...
def btl_c1_residuals_station_deep_plot(df):
    ...
    fig.savefig('./data/images/btlcond_c1_stn_deep.ps', format='ps')
    fig.savefig('./data/images/btlcond_c1_stn_deep.png', format='png')
    plt.close()
    return None
...
def btl_c2_residuals_station_deep_plot(df):
    ...
    fig.savefig('./data/images/btlcond_c2_stn_deep.ps', format='ps')
    fig.savefig('./data/images/btlcond_c2_stn_deep.png', format='png')
    plt.close()
    return None
...
def c1_c2_residuals_station_deep_plot(df):
    ...
    fig.savefig('./data/images/c1_c2_stn_deep.ps', format='ps')
    fig.savefig('./data/images/c1_c2_stn_deep.png', format='png')
    plt.close()
    return None
...
def c_t_coherence_plot(df):
    ...
    fig.savefig('./data/images/c_t_coherence_p.ps', format='ps')
    fig.savefig('./data/images/c_t_coherence_p.png', format='png')
    plt.close()
    return None
...
def btl_c1_residuals_compare_plot(df):
    ...
    fig.savefig('./data/images/btlcond_c1_compare.ps', format='ps')
    fig.savefig('./data/images/btlcond_c1_compare.png', format='png')
    plt.close()
    return None
...
def btl_c2_residuals_compare_plot(df):
    ...
    fig.savefig('./data/images/btlcond_c2_compare.ps', format='ps')
    fig.savefig('./data/images/btlcond_c2_compare.png', format='png')
    plt.close()
    return None
...
def c1_c2_residuals_compare_plot(df):
    ...
    fig.savefig('./data/images/c1_c2_compare.ps', format='ps')
    fig.savefig('./data/images/c1_c2_compare.png', format='png')
    plt.close()
    return None
...
def btl_c1_residuals_station_uncorrected_plot(df):
    ...
    fig.savefig('./data/images/btlcond_c1_stn_uncorrected.ps', format='ps')
    fig.savefig('./data/images/btlcond_c1_stn_uncorrected.png', format='png')
    plt.close()
    return None
...
def btl_c2_residuals_station_uncorrected_plot(df):
    ...
    fig.savefig('./data/images/btlcond_c2_stn_uncorrected.ps', format='ps')
    fig.savefig('./data/images/btlcond_c2_stn_uncorrected.png', format='png')
    plt.close()
    return None
...
def c1_c2_residuals_station_uncorrected_plot(df):
    ...
    fig.savefig('./data/images/c1_c2_stn_uncorrected.ps', format='ps')
    fig.savefig('./data/images/c1_c2_stn_uncorrected.png', format='png')
    plt.close()
    return None
...
def btl_sal_pressure_plot(df):
    ...
    fig.savefig('./data/images/btlsal_sal_p.ps', format='ps')
    fig.savefig('./data/images/btlsal_sal_p.png', format='png')
    plt.close()
    return None
...
def btl_sal_station_plot(df):
    ...
    fig.savefig('./data/images/btlsal_sal_stn.ps', format='ps')
    fig.savefig('./data/images/btlsal_sal_stn.png', format='png')
    plt.close()
    return None
...
def btl_sal_station_deep_plot(df):
    ...
    fig.savefig('./data/images/btlsal_sal_stn_deep.ps', format='ps')
    fig.savefig('./data/images/btlsal_sal_stn_deep.png', format='png')
    plt.close()
    return None
...
def btl_oxy_residuals_pressure_plot(df):
    ...
    fig.savefig('./data/images/btl_oxy_p.ps', format='ps')
    fig.savefig('./data/images/btl_oxy_p.png', format='png')
    plt.close()
    return None
...
def btl_oxy_residuals_station_plot(df):
    ...
    fig.savefig('./data/images/btl_oxy_stn.ps', format='ps')
    fig.savefig('./data/images/btl_oxy_stn.png', format='png')
    plt.close()
    return None
...
def btl_oxy_residuals_station_deep_plot(df):
    ...
    fig.savefig('./data/images/btl_oxy_stn_deep.ps', format='ps')
    fig.savefig('./data/images/btl_oxy_stn_deep.png', format='png')
    plt.close()
    return None
...
def btl_oxy_residuals_temperature_plot(df):
    ...
    fig.savefig('./data/images/btl_oxy_t.ps', format='ps')
    fig.savefig('./data/images/btl_oxy_t.png', format='png')
    plt.close()
    return None
...
def btl_oxy_residuals_station_temperature_plot(df):
    ...
    fig.savefig('./data/images/btl_oxy_stn_t.ps', format='ps')
    fig.savefig('./data/images/btl_oxy_stn_t.png', format='png')
    plt.close()
    return None
...
def btl_oxy_residuals_station_deep_temperature_plot(df):
    ...
    fig.savefig('./data/images/btl_oxy_stn_deep_t.ps', format='ps')
    fig.savefig('./data/images/btl_oxy_stn_deep_t.png', format='png')
    plt.close()
    return None
...
def btl_oxy_residuals_pressure_concentration_plot(df):
    ...
    fig.savefig('./data/images/btl_oxy_p_concentration.ps', format='ps')
    fig.savefig('./data/images/btl_oxy_p_concentration.png', format='png')
    plt.close()
    return None
...
def btl_oxy_residuals_station_concentration_plot(df):
    ...
    fig.savefig('./data/images/btl_oxy_stn_concentration.ps', format='ps')
    fig.savefig('./data/images/btl_oxy_stn_concentration.png', format='png')
    plt.close()
    return None
