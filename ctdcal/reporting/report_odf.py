...
def make_odf_report_table(df, outdir):
    """
    ...
    """
    df["STNNBR"] = [int(x[0:3]) for x in df["cast_id"]]
...
def export_report_data(df):
    ...
    """
    log.warning("Use of export_report_data is deprecated. Use make_odf_report_table instead.")
