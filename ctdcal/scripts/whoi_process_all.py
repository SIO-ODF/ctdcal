...
Recall adjustments to main: ctdcal process -g WHOI
...
def whoi_process_all(group="WHOI"):
    ...
    print("Converting turbidity and fluorescence to science units.")
    #   Using the 2019 calibration sheet from the SSSGs
    btl_data_fit["CTDFLUOR2"] = 11 * (btl_data_fit.CTDFLUOR - 0.079)   #   ug/L which equals mg/m^3 (x 1000 / 1000)
    btl_data_fit["CTDTURB2"] = 5 * (btl_data_fit.TURBIDITY - 0.050)  #   In NTU. good to go
    time_data_fit["CTDFLUOR2"] = 11 * (time_data_fit.CTDFLUOR - 0.079)
    time_data_fit["CTDTURB2"] = 5 * (time_data_fit.CTDFLUOR - 0.050)
    btl_data_fit["CTDFLUOR_FLAG_W"] = btl_data_fit["CTDTURB_FLAG_W"] = 1
    time_data_fit["CTDFLUOR_FLAG_W"] = time_data_fit["CTDTURB_FLAG_W"] = 1
    btl_data_fit["CTDXMISS_FLAG_W"] = 1 #   Not defined otherwise

    btl_data_fit["CTDFLUOR"] = btl_data_fit["CTDFLUOR2"]    #   Changing off the voltages
    btl_data_fit["CTDTURB"] = btl_data_fit["CTDTURB2"]
    btl_data_fit = btl_data_fit.where(~btl_data_fit.isnull(), -999)
    

    process_bottle.export_hy1(btl_data_fit)
    #####
    # Step 3: export data
    #####
    ...
    try:
        ...
        # )
        # outfile = cfg.dirs["pressure"] + cfg.expocode + "_hy1.csv"
        # btl_cols = {
        #     "SSSCC": "Station",
        #     "DateTime": "",
        #     "GPSLAT": "Dec Degrees",
        ...
        print("Could not export final bottle data.")
