...
from ctdcal.fitting.fit_ctd import load_time_all, calibrate_pressure, \
...
from ctdcal.reporting.report_odf import make_depth_log, make_odf_report_table
...
def odf_process_all():
    ...
    if not skip_calibrate:
        ...
        btl_data_all, time_data_all = calibrate_conductivity(btl_data_all, time_data_all, fit_groups.conductivity,
                                                             fit_coeffs.conductivity, salt_figdir, reportdir, flagfile,
                                                             cast_id_col='cast_id')
