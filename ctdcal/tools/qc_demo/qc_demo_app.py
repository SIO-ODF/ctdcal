...
st.session_state.exchange_dir = Path('/Users/als026/data/p04e/cruise_data/save')
st.session_state.flag_file = Path('/Users/als026/data/p04e/cruise_data/flag/bottle_flags_manual.json')
