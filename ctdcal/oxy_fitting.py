...
#       Recalculate coeficients
        #If we run into an error where there isn't enough good bottle data to
        #recalculate coefficients, then break out of the while loop by catching
        #the TypeError.
        #"TypeError: Improper input: N=5 must not exceed M=4"
        #TODO: determine why it needs a minimum of 5 bottles, is similar to
